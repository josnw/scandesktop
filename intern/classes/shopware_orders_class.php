...
class ShopwareOrders {
	...
	private function getFacCustomerData($data) {
		...
		$facCustomer = [
			...
			'QEMA' => $data["paymentInstances"]["email"],
			'qkt1' => $data["paymentInstances"]["bankName"],
			'qbl1' => $data["paymentInstances"]["bankCode"],
			'qkn1' => $data["paymentInstances"]["accountNumber"],
			'qki1' => $data["paymentInstances"]["iban"],
			'qkb1' => $data["paymentInstances"]["bic"],
	...
	private function getFacHeadData($data) {
		...
		$facHead = [
			...
			'SIGS' => $data["document"]["amount"],
			'SGES' => $data["document"]["amount"],
